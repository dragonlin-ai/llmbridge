...
![llmbridge Architecture](.github/images/architecture.en.svg)

*Request pipeline: /v1 public gateway → router engine → adapter layer → model pool → data layer; /admin console manages configuration.*
